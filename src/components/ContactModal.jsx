...
const ContactModal = ({ open, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-3 sm:p-4">
      ...
      <div className="relative w-full max-w-6xl max-h-[95vh] overflow-y-auto bg-white dark:bg-slate-900 rounded-3xl shadow-2xl border border-slate-100/80 dark:border-slate-700/60">
        <button
          type="button"
          onClick={onClose}
